...
const products = Array.from({ length: 20 }, (_, i) => ({
  id: i + 1,
  name: 'Hemp Wraps Product ' + (i + 1),
  slug: 'hemp-wraps-product-' + (i + 1),
  image: 'https://via.placeholder.com/300x200?text=hemp+wraps+' + (i + 1),
    ...
    <div className="p-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {products.map(product => (
          <Link key={product.id} href={`/products/hemp-wraps/${product.slug}`}>
